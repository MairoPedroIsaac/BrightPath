document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchApplications() {
      try {
        const response = await fetch('https://brightpath-zp6i.onrender.com/applications');
    ...
    window.updateStatus = async function(id, status) {
      try {
        const response = await fetch(`https://brightpath-zp6i.onrender.com/applications/${id}`, {
          method: 'PUT',
          headers: {
